...
def create_individuals(data):
    ...
    if data["subject"] and "id" and "sex" in data["subject"]:  # mandatory fields for Individuals
        ...
        if "phenotypicFeatures" in data:
            ...
            for phenotypicFeature in data["phenotypicFeatures"]:
                ...
                individuals_beacon_dict.setdefault("phenotypicFeatures", []).append(updated_phenotypicFeature)  ## add it to beacon language dict
